...
public class VoitureController {
	...
	public String saveVoiture(@Valid Voiture voiture,BindingResult bindingResult,@ModelAttribute("page") int pageFromPrevious,@RequestParam (name="size", defaultValue = "2") int size,
			RedirectAttributes redirectAttributes,
			ModelMap modelMap
			) {
		 int page;
		if (bindingResult.hasErrors())
			{List<Marque> marques = voitureService.getAllmarque();
	    		modelMap.addAttribute("marque", marques);
